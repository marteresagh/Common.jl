...
Visualization.VIEW([
	Visualization.GLPoints(convert(Lar.Points,p1'),Visualization.COLORS[2])
	Visualization.GLPoints(convert(Lar.Points,p2'),Visualization.COLORS[2])
...
Visualization.VIEW([
	Visualization.GLPoints(convert(Lar.Points,centroid'),Visualization.COLORS[2])
...
Visualization.VIEW([
	Visualization.GLPoints(convert(Lar.Points,V_int'))
